...
//defline REPROT_CHANNEL_HOLD_DATA							// Activate to display detailed SBUS Channel Hold information
...
#warning DONT FLASH WITH REPORT_SBUS_16CH_FRAME_SYNC_DATA ACTIVATED
#endif